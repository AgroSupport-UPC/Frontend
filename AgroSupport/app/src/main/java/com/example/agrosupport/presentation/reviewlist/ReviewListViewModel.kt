...
import com.example.agrosupport.presentation.advisorlist.AdvisorCard
    ...
    fun getAdvisorDetail(advisorId: Long) {
        ...
        viewModelScope.launch {
            try {
                ...
                _advisorCard.value = UIState(message = "Error al intentar obtener el asesor: ${e.message}")
            }
        }
    }
    ...
    fun getAdvisorReviewList(advisorId: Long) {
        ...
        viewModelScope.launch {
            try {
                ...
                _state.value = UIState(message = "Error al intentar obtener las reseñas del asesor: ${e.message}")
            }
        }
    }
}